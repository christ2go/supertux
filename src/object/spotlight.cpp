...
ObjectSettings Spotlight::get_settings() {
  ...
  result.add_bool(_("Counter-clockwise"), &counter_clockwise,
...
HitResponse Spotlight::collision(GameObject& other, const CollisionHit& hit_) {
  return FORCE_MOVE;
}

...
ObjectSettings Thunderstorm::get_settings() {
...
void Thunderstorm::update(float) {
  if (!running) return;
...
void Thunderstorm::electrify() {
  auto changing_tiles = Electrifier::TileChangeMap(
      {{200, 1421},  {201, 1422},  {3419, 3523}, {3420, 3524}, {3421, 3525},
       {3422, 3526}, {3423, 3527}, {3424, 3528}, {3425, 3529}, {3426, 3530},
       {3427, 3523}, {3428, 3524}, {3429, 3525}, {3430, 3526}, {3431, 3527},
       {3432, 3528}, {3433, 3529}, {3434, 3530}, {2019, 3873}, {2140, 3874},
       {2141, 3875}, {2142, 3876}, {2020, 3877}});

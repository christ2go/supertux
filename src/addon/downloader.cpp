...
size_t my_curl_string_append(void* ptr, size_t size, size_t nmemb,
                             void* userdata) {
...
size_t my_curl_physfs_write(void* ptr, size_t size, size_t nmemb,
                            void* userdata) {
...
void TransferStatus::abort() { m_downloader.abort(id); }

void TransferStatus::update() { m_downloader.update(); }
...
void Downloader::download(const std::string& url,
                          size_t (*write_func)(void* ptr, size_t size,
...
void Downloader::download(const std::string& url, const std::string& filename) {
...
void Downloader::abort(TransferId id) {
...
TransferStatusPtr Downloader::request_download(const std::string& url,
                                               const std::string& outfile) {
  log_info << "request_download: " << url << std::endl;
  auto transfer =
      std::make_unique<Transfer>(*this, m_next_transfer_id++, url, outfile);

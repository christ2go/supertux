...
const Controller& InputManager::get_controller() const { return *controller; }

Controller& InputManager::get_controller() { return *controller; }

void InputManager::use_game_controller(bool v) { m_use_game_controller = v; }

void InputManager::update() { controller->update(); }

void InputManager::reset() { controller->reset(); }

...
std::unique_ptr<SoundFile> load_music_file(
...
SoundFile::FileFormat SoundFile::get_file_format(PHYSFS_File* file,
...
std::unordered_map<std::string, std::string> fallback_paths = {
    ...
    {"beneath_the_rabbit_hole.music",
     "/music/forest/beneath_the_rabbit_hole.music"},
    {"beneath_the_rabbit_hole.ogg",
     "/music/forest/beneath_the_rabbit_hole.ogg"},
...
const std::string& get_fallback_path(const std::string& file_path) {
  ...
  if (it != fallback_paths.end()) return it->second;

...
SDLScreenRenderer::SDLScreenRenderer(SDLVideoSystem& video_system,
...
void SDLScreenRenderer::end_draw() {}

Rect SDLScreenRenderer::get_rect() const {
  return m_video_system.get_viewport().get_rect();
}

Size SDLScreenRenderer::get_logical_size() const {
  return m_video_system.get_viewport().get_screen_size();
}

void SDLScreenRenderer::flip() { SDL_RenderPresent(m_renderer); }

...
Tile::Tile(const std::vector<SurfacePtr>& images,
           const std::vector<SurfacePtr>& editor_images, uint32_t attributes,
...
void Tile::draw(Canvas& canvas, const Vector& pos, int z_pos,
                const Color& color) const {
  if (draw_editor_images) {
    if (m_editor_images.size() > 1) {
      size_t frame = size_t(g_game_time * m_fps) % m_editor_images.size();
      canvas.draw_surface(m_editor_images[frame], pos, 0, color, Blend(),
                          z_pos);
      return;
...
void Tile::draw_debug(Canvas& canvas, const Vector& pos, int z_pos,
                      const Color& color) const {
  if (!is_slope()) {
    ...
    switch (slope_info) {
      case AATriangle::SOUTHWEST:
        canvas.draw_triangle({pos.x, pos.y}, {pos.x, pos.y + 32.0f},
                             {pos.x + 32.0f, pos.y + 32.0f}, color, z_pos);
        break;

      case AATriangle::NORTHEAST:
        canvas.draw_triangle({pos.x, pos.y}, {pos.x + 32.0f, pos.y},
                             {pos.x + 32.0f, pos.y + 32.0f}, color, z_pos);
        break;

      case AATriangle::SOUTHEAST:
        canvas.draw_triangle({pos.x, pos.y + 32.0f}, {pos.x + 32.0f, pos.y},
                             {pos.x + 32.0f, pos.y + 32.0f}, color, z_pos);
        break;

      case AATriangle::NORTHWEST:
        canvas.draw_triangle({pos.x, pos.y}, {pos.x + 32.0f, pos.y},
                             {pos.x, pos.y + 32.0f}, color, z_pos);
        break;

      case AATriangle::SOUTHWEST | AATriangle::DEFORM_BOTTOM:
        canvas.draw_triangle({pos.x, pos.y + 16.0f}, {pos.x, pos.y + 32.0f},
                             {pos.x + 32.0f, pos.y + 32.0f}, color, z_pos);
        break;

      case AATriangle::NORTHEAST | AATriangle::DEFORM_BOTTOM:
        canvas.draw_filled_rect(
            Rectf(pos.x, pos.y, pos.x + 32.0f, pos.y + 16.0f), color, z_pos);
        canvas.draw_triangle({pos.x, pos.y + 16.0f},
                             {pos.x + 32.0f, pos.y + 16.0f},
                             {pos.x + 32.0f, pos.y + 32.0f}, color, z_pos);
        break;

      case AATriangle::SOUTHEAST | AATriangle::DEFORM_BOTTOM:
        canvas.draw_triangle({pos.x + 32.0f, pos.y + 32.0f},
                             {pos.x, pos.y + 32.0f},
                             {pos.x + 32.0f, pos.y + 16.0f}, color, z_pos);
        break;

      case AATriangle::NORTHWEST | AATriangle::DEFORM_BOTTOM:
        canvas.draw_filled_rect(
            Rectf(pos.x, pos.y, pos.x + 32.0f, pos.y + 16.0f), color, z_pos);
        canvas.draw_triangle({pos.x, pos.y + 32.0f},
                             {pos.x + 32.0f, pos.y + 16.0f},
                             {pos.x, pos.y + 16.0f}, color, z_pos);
        break;

      case AATriangle::SOUTHWEST | AATriangle::DEFORM_TOP:
        canvas.draw_filled_rect(
            Rectf(pos.x, pos.y + 16.0f, pos.x + 32.0f, pos.y + 32.0f), color,
            z_pos);
        canvas.draw_triangle({pos.x, pos.y + 16.0f},
                             {pos.x + 32.0f, pos.y + 16.0f}, {pos.x, pos.y},
                             color, z_pos);
        break;

      case AATriangle::NORTHEAST | AATriangle::DEFORM_TOP:
        canvas.draw_triangle({pos.x + 32.0f, pos.y},
                             {pos.x + 32.0f, pos.y + 16.0f}, {pos.x, pos.y},
                             color, z_pos);
        break;
      ...
      case AATriangle::SOUTHEAST | AATriangle::DEFORM_TOP:
        canvas.draw_filled_rect(
            Rectf(pos.x, pos.y + 16.0f, pos.x + 32.0f, pos.y + 32.0f), color,
            z_pos);
        canvas.draw_triangle({pos.x + 32.0f, pos.y + 16.0f},
                             {pos.x, pos.y + 16.0f}, {pos.x + 32.0f, pos.y},
                             color, z_pos);
        break;
      ...
      case AATriangle::SOUTHWEST | AATriangle::DEFORM_LEFT:
        canvas.draw_triangle({pos.x, pos.y + 32.0f}, {pos.x, pos.y},
                             {pos.x + 16.0f, pos.y + 32.0f}, color, z_pos);
        break;

      case AATriangle::NORTHEAST | AATriangle::DEFORM_LEFT:
        canvas.draw_filled_rect(
            Rectf(pos.x + 16.0f, pos.y, pos.x + 32.0f, pos.y + 32.0f), color,
            z_pos);
        canvas.draw_triangle({pos.x + 16.0f, pos.y},
                             {pos.x + 16.0f, pos.y + 32.0f}, {pos.x, pos.y},
                             color, z_pos);
        break;
      ...
      case AATriangle::SOUTHEAST | AATriangle::DEFORM_LEFT:
        canvas.draw_filled_rect(
            Rectf(pos.x + 16.0f, pos.y, pos.x + 32.0f, pos.y + 32.0f), color,
            z_pos);
        canvas.draw_triangle({pos.x + 16.0f, pos.y + 32.0f},
                             {pos.x, pos.y + 32.0f}, {pos.x + 16.0f, pos.y},
                             color, z_pos);
        break;

      case AATriangle::NORTHWEST | AATriangle::DEFORM_LEFT:
        canvas.draw_triangle({pos.x, pos.y}, {pos.x + 16.0f, pos.y},
                             {pos.x, pos.y + 16.0f}, color, z_pos);
        break;

      case AATriangle::SOUTHWEST | AATriangle::DEFORM_RIGHT:
        canvas.draw_filled_rect(
            Rectf(pos.x, pos.y, pos.x + 16.0f, pos.y + 32.0f), color, z_pos);
        canvas.draw_triangle({pos.x + 16.0f, pos.y + 32.0f},
                             {pos.x + 16.0f, pos.y},
                             {pos.x + 32.0f, pos.y + 32.0f}, color, z_pos);
        break;
      ...
      case AATriangle::NORTHEAST | AATriangle::DEFORM_RIGHT:
        canvas.draw_triangle({pos.x + 32.0f, pos.y},
                             {pos.x + 32.0f, pos.y + 32.0f},
                             {pos.x + 16.0f, pos.y}, color, z_pos);
        break;

      case AATriangle::SOUTHEAST | AATriangle::DEFORM_RIGHT:
        canvas.draw_triangle({pos.x + 32.0f, pos.y + 32.0f},
                             {pos.x + 16.0f, pos.y + 32.0f},
                             {pos.x + 32.0f, pos.y}, color, z_pos);
        break;

      case AATriangle::NORTHWEST | AATriangle::DEFORM_RIGHT:
        canvas.draw_filled_rect(
            Rectf(pos.x, pos.y, pos.x + 16.0f, pos.y + 32.0f), color, z_pos);
        canvas.draw_triangle({pos.x + 16.0f, pos.y}, {pos.x + 32.0f, pos.y},
                             {pos.x + 16.0f, pos.y + 32.0f}, color, z_pos);
        break;
    }
  }
...
SurfacePtr Tile::get_current_surface() const {
  if (m_images.size() > 1) {
    size_t frame = size_t(g_game_time * m_fps) % m_images.size();
...
SurfacePtr Tile::get_current_editor_surface() const {
  if (m_editor_images.size() > 1) {
    size_t frame = size_t(g_game_time * m_fps) % m_editor_images.size();
...
bool Tile::check_movement_unisolid(const Vector& movement) const {
  ...
  //   / !
  //  +--+
  mv_x = static_cast<double>(
      movement.x);  // note switch to double for no good reason
...
bool Tile::is_solid(const Rectf& tile_bbox, const Rectf& position,
                    const Vector& movement) const {
  if (!(m_attributes & SOLID)) return false;

  return is_collisionful(tile_bbox, position, movement);
}

bool Tile::is_collisionful(const Rectf& tile_bbox, const Rectf& position,
                           const Vector& movement) const {
  if (!(m_attributes & UNISOLID)) return true;
